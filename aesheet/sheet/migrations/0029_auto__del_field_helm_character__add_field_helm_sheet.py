...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Helm.character'
        db.delete_column('sheet_helm', 'character_id')

        # Adding field 'Helm.sheet'
        db.add_column('sheet_helm', 'sheet', self.gf('django.db.models.fields.related.OneToOneField')(default=0, related_name='helm', unique=True, to=orm['sheet.Sheet']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Helm.character'
        db.add_column('sheet_helm', 'character', self.gf('django.db.models.fields.related.OneToOneField')(default=0, related_name='helm', unique=True, to=orm['sheet.Character']), keep_default=False)

        # Deleting field 'Helm.sheet'
        db.delete_column('sheet_helm', 'sheet_id')
    ...
    models = {
        ...
        'sheet.helm': {
            ...
            'sheet': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'helm'", 'unique': 'True', 'to': "orm['sheet.Sheet']"})
        },
        'sheet.sheet': {
