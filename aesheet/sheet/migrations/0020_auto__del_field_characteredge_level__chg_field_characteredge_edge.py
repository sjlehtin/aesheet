...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CharacterEdge.level'
        db.delete_column('sheet_characteredge', 'level')

        # Changing field 'CharacterEdge.edge'
        db.alter_column('sheet_characteredge', 'edge_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.EdgeLevel']))


    def backwards(self, orm):
        
        # Adding field 'CharacterEdge.level'
        db.add_column('sheet_characteredge', 'level', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Changing field 'CharacterEdge.edge'
        db.alter_column('sheet_characteredge', 'edge_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.Edge']))
