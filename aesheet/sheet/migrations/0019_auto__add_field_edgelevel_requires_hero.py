...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EdgeLevel.requires_hero'
        db.add_column('sheet_edgelevel', 'requires_hero', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EdgeLevel.requires_hero'
        db.delete_column('sheet_edgelevel', 'requires_hero')
