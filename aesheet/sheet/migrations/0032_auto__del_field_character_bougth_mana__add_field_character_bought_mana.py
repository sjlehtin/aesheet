...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Character.bougth_mana'
        db.delete_column('sheet_character', 'bougth_mana')

        # Adding field 'Character.bought_mana'
        db.add_column('sheet_character', 'bought_mana', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Character.free_edges'
        db.add_column('sheet_character', 'free_edges', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)

        # Adding field 'Character.gained_edges'
        db.add_column('sheet_character', 'gained_edges', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Character.bougth_mana'
        db.add_column('sheet_character', 'bougth_mana', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Character.bought_mana'
        db.delete_column('sheet_character', 'bought_mana')

        # Deleting field 'Character.free_edges'
        db.delete_column('sheet_character', 'free_edges')

        # Deleting field 'Character.gained_edges'
        db.delete_column('sheet_character', 'gained_edges')
    ...
    models = {
        ...
        'sheet.character': {
            ...
            'gained_edges': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
