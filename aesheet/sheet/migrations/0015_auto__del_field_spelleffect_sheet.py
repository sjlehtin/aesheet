...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SpellEffect.sheet'
        db.delete_column('sheet_spelleffect', 'sheet_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'SpellEffect.sheet'
        db.add_column('sheet_spelleffect', 'sheet', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='spell_effects', to=orm['sheet.Sheet']), keep_default=False)
