...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Weapon.quality' to match new field type.
        db.rename_column('sheet_weapon', 'quality', 'quality_id')
        # Changing field 'Weapon.quality'
        db.alter_column('sheet_weapon', 'quality_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.WeaponQuality']))

        # Adding index on 'Weapon', fields ['quality']
        db.create_index('sheet_weapon', ['quality_id'])
    ...
    def backwards(self, orm):
        ...
        # Renaming column for 'Weapon.quality' to match new field type.
        db.rename_column('sheet_weapon', 'quality_id', 'quality')
        # Changing field 'Weapon.quality'
        db.alter_column('sheet_weapon', 'quality', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Removing index on 'Weapon', fields ['quality']
        db.delete_index('sheet_weapon', ['quality_id'])
