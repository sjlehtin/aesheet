...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sheet_weapon', (
            ...
            ('quality', self.gf('django.db.models.fields.CharField')(default='Normal', max_length=1)),
        ))
        ...
        # Changing field 'Character.description'
        db.alter_column('sheet_character', 'description', self.gf('django.db.models.fields.TextField')(blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Character.description'
        db.alter_column('sheet_character', 'description', self.gf('django.db.models.fields.TextField')(max_length=256, blank=True))
    ...
    models = {
        ...
        'sheet.weapon': {
            ...
            'quality': ('django.db.models.fields.CharField', [], {'default': "'Normal'", 'max_length': '1'})
        },
