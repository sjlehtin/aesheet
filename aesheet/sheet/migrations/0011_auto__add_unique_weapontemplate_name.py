...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'WeaponTemplate', fields ['name']
        db.create_unique('sheet_weapontemplate', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'WeaponTemplate', fields ['name']
        db.delete_unique('sheet_weapontemplate', ['name'])
