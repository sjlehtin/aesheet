...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WeaponTemplate.base_skill'
        db.add_column('sheet_weapontemplate', 'base_skill', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='base_skill_for_weapons', to=orm['sheet.Skill']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WeaponTemplate.base_skill'
        db.delete_column('sheet_weapontemplate', 'base_skill_id')
