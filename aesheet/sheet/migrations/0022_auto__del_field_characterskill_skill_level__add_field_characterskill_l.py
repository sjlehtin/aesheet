...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CharacterSkill.skill_level'
        db.delete_column('sheet_characterskill', 'skill_level')

        # Adding field 'CharacterSkill.level'
        db.add_column('sheet_characterskill', 'level', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CharacterSkill.skill_level'
        db.add_column('sheet_characterskill', 'skill_level', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'CharacterSkill.level'
        db.delete_column('sheet_characterskill', 'level')
