...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Edge.id'
        db.delete_column('sheet_edge', 'id')

        # Changing field 'Edge.name'
        db.alter_column('sheet_edge', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, primary_key=True))

        # Deleting field 'WeaponTemplate.id'
        db.delete_column('sheet_weapontemplate', 'id')

        # Changing field 'WeaponTemplate.name'
        db.alter_column('sheet_weapontemplate', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, primary_key=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Edge.name'
        db.alter_column('sheet_edge', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True))

        # User chose to not deal with backwards NULL issues for 'WeaponTemplate.id'
        raise RuntimeError("Cannot reverse this migration. 'WeaponTemplate.id' and its values cannot be restored.")

        # Changing field 'WeaponTemplate.name'
        db.alter_column('sheet_weapontemplate', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True))
