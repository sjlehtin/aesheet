...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Skill.stat'
        db.add_column('sheet_skill', 'stat', self.gf('django.db.models.fields.CharField')(default='MOV', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Skill.stat'
        db.delete_column('sheet_skill', 'stat')
