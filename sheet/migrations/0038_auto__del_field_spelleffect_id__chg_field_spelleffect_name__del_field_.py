...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SpellEffect.id'
        db.delete_column('sheet_spelleffect', 'id')

        # Changing field 'SpellEffect.name'
        db.alter_column('sheet_spelleffect', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, primary_key=True))

        # Deleting field 'WeaponEffect.id'
        db.delete_column('sheet_weaponeffect', 'id')

        # Changing field 'WeaponEffect.name'
        db.alter_column('sheet_weaponeffect', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, primary_key=True))

        # Deleting field 'ArmorEffect.id'
        db.delete_column('sheet_armoreffect', 'id')

        # Changing field 'ArmorEffect.name'
        db.alter_column('sheet_armoreffect', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, primary_key=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'SpellEffect.id'
        raise RuntimeError("Cannot reverse this migration. 'SpellEffect.id' and its values cannot be restored.")

        # Changing field 'SpellEffect.name'
        db.alter_column('sheet_spelleffect', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True))

        # User chose to not deal with backwards NULL issues for 'WeaponEffect.id'
        raise RuntimeError("Cannot reverse this migration. 'WeaponEffect.id' and its values cannot be restored.")

        # Changing field 'WeaponEffect.name'
        db.alter_column('sheet_weaponeffect', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True))

        # User chose to not deal with backwards NULL issues for 'ArmorEffect.id'
        raise RuntimeError("Cannot reverse this migration. 'ArmorEffect.id' and its values cannot be restored.")

        # Changing field 'ArmorEffect.name'
        db.alter_column('sheet_armoreffect', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True))
