...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EdgeSkillBonus'
        db.create_table('sheet_edgeskillbonus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('edge_level', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.EdgeLevel'])),
            ('skill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.Skill'])),
            ('bonus', self.gf('django.db.models.fields.IntegerField')(default=15)),
        ))
        db.send_create_signal('sheet', ['EdgeSkillBonus'])


    def backwards(self, orm):
        # Deleting model 'EdgeSkillBonus'
        db.delete_table('sheet_edgeskillbonus')
