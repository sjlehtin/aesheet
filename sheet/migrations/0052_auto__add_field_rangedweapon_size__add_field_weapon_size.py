...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RangedWeapon.size'
        db.add_column(u'sheet_rangedweapon', 'size',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Weapon.size'
        db.add_column(u'sheet_weapon', 'size',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RangedWeapon.size'
        db.delete_column(u'sheet_rangedweapon', 'size')

        # Deleting field 'Weapon.size'
        db.delete_column(u'sheet_weapon', 'size')
