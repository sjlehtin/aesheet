...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArmorTemplate.armor_ra_f'
        db.delete_column('sheet_armortemplate', 'armor_ra_f')

        # Deleting field 'ArmorTemplate.armor_h_f'
        db.delete_column('sheet_armortemplate', 'armor_h_f')

        # Deleting field 'ArmorTemplate.armor_ll_f'
        db.delete_column('sheet_armortemplate', 'armor_ll_f')

        # Deleting field 'ArmorTemplate.armor_la_f'
        db.delete_column('sheet_armortemplate', 'armor_la_f')

        # Deleting field 'ArmorTemplate.armor_rl_f'
        db.delete_column('sheet_armortemplate', 'armor_rl_f')

        # Deleting field 'ArmorTemplate.armor_t_f'
        db.delete_column('sheet_armortemplate', 'armor_t_f')


    def backwards(self, orm):
        # Adding field 'ArmorTemplate.armor_ra_f'
        db.add_column('sheet_armortemplate', 'armor_ra_f',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=1),
                      keep_default=False)

        # Adding field 'ArmorTemplate.armor_h_f'
        db.add_column('sheet_armortemplate', 'armor_h_f',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=1),
                      keep_default=False)

        # Adding field 'ArmorTemplate.armor_ll_f'
        db.add_column('sheet_armortemplate', 'armor_ll_f',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=1),
                      keep_default=False)

        # Adding field 'ArmorTemplate.armor_la_f'
        db.add_column('sheet_armortemplate', 'armor_la_f',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=1),
                      keep_default=False)

        # Adding field 'ArmorTemplate.armor_rl_f'
        db.add_column('sheet_armortemplate', 'armor_rl_f',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=1),
                      keep_default=False)

        # Adding field 'ArmorTemplate.armor_t_f'
        db.add_column('sheet_armortemplate', 'armor_t_f',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=1),
                      keep_default=False)
