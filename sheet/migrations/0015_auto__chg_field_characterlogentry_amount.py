...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CharacterLogEntry.amount'
        db.alter_column('sheet_characterlogentry', 'amount', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'CharacterLogEntry.amount'
        db.alter_column('sheet_characterlogentry', 'amount', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 9, 18, 9, 10, 251726)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 9, 18, 9, 10, 251593)'}),
