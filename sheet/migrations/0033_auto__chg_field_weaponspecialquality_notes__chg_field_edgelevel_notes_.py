...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WeaponSpecialQuality.notes'
        db.alter_column(u'sheet_weaponspecialquality', 'notes', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'EdgeLevel.notes'
        db.alter_column(u'sheet_edgelevel', 'notes', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'SpellEffect.notes'
        db.alter_column(u'sheet_spelleffect', 'notes', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'ArmorSpecialQuality.notes'
        db.alter_column(u'sheet_armorspecialquality', 'notes', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'WeaponSpecialQuality.notes'
        db.alter_column(u'sheet_weaponspecialquality', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'EdgeLevel.notes'
        db.alter_column(u'sheet_edgelevel', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'SpellEffect.notes'
        db.alter_column(u'sheet_spelleffect', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ArmorSpecialQuality.notes'
        db.alter_column(u'sheet_armorspecialquality', 'notes', self.gf('django.db.models.fields.TextField')(null=True))
