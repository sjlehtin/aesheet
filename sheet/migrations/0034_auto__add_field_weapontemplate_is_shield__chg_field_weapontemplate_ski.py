...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WeaponTemplate.is_shield'
        db.add_column('sheet_weapontemplate', 'is_shield', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'WeaponTemplate.skill'
        db.alter_column('sheet_weapontemplate', 'skill_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['sheet.Skill']))


    def backwards(self, orm):
        
        # Deleting field 'WeaponTemplate.is_shield'
        db.delete_column('sheet_weapontemplate', 'is_shield')

        # Changing field 'WeaponTemplate.skill'
        db.alter_column('sheet_weapontemplate', 'skill_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.Skill']))
