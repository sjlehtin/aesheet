...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RangedWeapon'
        db.create_table('sheet_rangedweapon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('base', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.RangedWeaponTemplate'])),
            ('quality', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.WeaponQuality'])),
            ('ammo_quality', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rangedweaponammo_set', to=orm['sheet.WeaponQuality'])),
        ))
        db.send_create_signal('sheet', ['RangedWeapon'])

        # Adding M2M table for field special_qualities on 'RangedWeapon'
        db.create_table('sheet_rangedweapon_special_qualities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rangedweapon', models.ForeignKey(orm['sheet.rangedweapon'], null=False)),
            ('weaponspecialquality', models.ForeignKey(orm['sheet.weaponspecialquality'], null=False))
        ))
        db.create_unique('sheet_rangedweapon_special_qualities', ['rangedweapon_id', 'weaponspecialquality_id'])

        # Adding model 'RangedWeaponTemplate'
        db.create_table('sheet_rangedweapontemplate', (
            ...
            ('base_skill', self.gf('django.db.models.fields.related.ForeignKey')(related_name='base_skill_for_rangedweapontemplate', to=orm['sheet.Skill'])),
            ('skill', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='primary_for_rangedweapontemplate', null=True, to=orm['sheet.Skill'])),
            ('skill2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='secondary_for_rangedweapontemplate', null=True, to=orm['sheet.Skill'])),
            ...
            ('range_xs', self.gf('django.db.models.fields.IntegerField')()),
            ('range_vs', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('range_xl', self.gf('django.db.models.fields.IntegerField')()),
            ('range_e', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('sheet', ['RangedWeaponTemplate'])

        # Adding M2M table for field ranged_weapons on 'Sheet'
        db.create_table('sheet_sheet_ranged_weapons', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sheet', models.ForeignKey(orm['sheet.sheet'], null=False)),
            ('rangedweapon', models.ForeignKey(orm['sheet.rangedweapon'], null=False))
        ))
        db.create_unique('sheet_sheet_ranged_weapons', ['sheet_id', 'rangedweapon_id'])


    def backwards(self, orm):
        # Deleting model 'RangedWeapon'
        db.delete_table('sheet_rangedweapon')

        # Removing M2M table for field special_qualities on 'RangedWeapon'
        db.delete_table('sheet_rangedweapon_special_qualities')

        # Deleting model 'RangedWeaponTemplate'
        db.delete_table('sheet_rangedweapontemplate')

        # Removing M2M table for field ranged_weapons on 'Sheet'
        db.delete_table('sheet_sheet_ranged_weapons')
    ...
    models = {
        ...
        'sheet.rangedweapon': {
            ...
            'ammo_quality': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rangedweaponammo_set'", 'to': "orm['sheet.WeaponQuality']"}),
