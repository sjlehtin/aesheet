...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ArmorTemplate.id'
        db.delete_column('sheet_armortemplate', 'id')

        # Changing field 'ArmorTemplate.name'
        db.alter_column('sheet_armortemplate', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, primary_key=True))

        # Adding unique constraint on 'ArmorTemplate', fields ['name']
        db.create_unique('sheet_armortemplate', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ArmorTemplate', fields ['name']
        db.delete_unique('sheet_armortemplate', ['name'])

        # User chose to not deal with backwards NULL issues for 'ArmorTemplate.id'
        raise RuntimeError("Cannot reverse this migration. 'ArmorTemplate.id' and its values cannot be restored.")

        # Changing field 'ArmorTemplate.name'
        db.alter_column('sheet_armortemplate', 'name', self.gf('django.db.models.fields.CharField')(max_length=256))
