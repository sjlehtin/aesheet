...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RangedWeaponTemplate.is_crossbow'
        db.add_column(u'sheet_rangedweapontemplate', 'is_crossbow',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WeaponQuality.max_fit'
        db.add_column(u'sheet_weaponquality', 'max_fit',
                      self.gf('django.db.models.fields.IntegerField')(default=90),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RangedWeaponTemplate.is_crossbow'
        db.delete_column(u'sheet_rangedweapontemplate', 'is_crossbow')

        # Deleting field 'WeaponQuality.max_fit'
        db.delete_column(u'sheet_weaponquality', 'max_fit')
    ...
    models = {
        ...
        u'sheet.rangedweapontemplate': {
            ...
            'durability': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
            'extra_damage': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'is_crossbow': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'leth': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256', 'primary_key': 'True'}),
            'notes': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            'num_dice': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
