...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CharacterLogEntry.level'
        db.delete_column('sheet_characterlogentry', 'level')

        # Adding field 'CharacterLogEntry.entry_type'
        db.add_column('sheet_characterlogentry', 'entry_type', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'CharacterLogEntry.skill_level'
        db.add_column('sheet_characterlogentry', 'skill_level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'CharacterLogEntry.edge_level'
        db.add_column('sheet_characterlogentry', 'edge_level', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CharacterLogEntry.level'
        db.add_column('sheet_characterlogentry', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Deleting field 'CharacterLogEntry.entry_type'
        db.delete_column('sheet_characterlogentry', 'entry_type')

        # Deleting field 'CharacterLogEntry.skill_level'
        db.delete_column('sheet_characterlogentry', 'skill_level')

        # Deleting field 'CharacterLogEntry.edge_level'
        db.delete_column('sheet_characterlogentry', 'edge_level')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 10, 0, 22, 17, 502052)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 10, 0, 22, 17, 501862)'}),
