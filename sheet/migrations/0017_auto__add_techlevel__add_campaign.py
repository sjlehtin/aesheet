...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TechLevel'
        db.create_table('sheet_techlevel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
        ))
        db.send_create_signal('sheet', ['TechLevel'])

        # Adding model 'Campaign'
        db.create_table('sheet_campaign', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
        ))
        db.send_create_signal('sheet', ['Campaign'])

        # Adding M2M table for field tech_levels on 'Campaign'
        db.create_table('sheet_campaign_tech_levels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('campaign', models.ForeignKey(orm['sheet.campaign'], null=False)),
            ('techlevel', models.ForeignKey(orm['sheet.techlevel'], null=False))
        ))
        db.create_unique('sheet_campaign_tech_levels', ['campaign_id', 'techlevel_id'])


    def backwards(self, orm):
        # Deleting model 'TechLevel'
        db.delete_table('sheet_techlevel')

        # Deleting model 'Campaign'
        db.delete_table('sheet_campaign')

        # Removing M2M table for field tech_levels on 'Campaign'
        db.delete_table('sheet_campaign_tech_levels')
