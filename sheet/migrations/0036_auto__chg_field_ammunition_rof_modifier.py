...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ammunition.rof_modifier'
        db.alter_column(u'sheet_ammunition', 'rof_modifier', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Ammunition.rof_modifier'
        db.alter_column(u'sheet_ammunition', 'rof_modifier', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=2))
    ...
    models = {
        ...
        u'sheet.ammunition': {
            ...
            'rof_modifier': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '4', 'decimal_places': '2'}),
