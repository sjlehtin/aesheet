...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CharacterLogEntry'
        db.create_table('sheet_characterlogentry', (
            ...
            ('field', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('amount', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('skill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.Skill'], null=True, blank=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('edge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.EdgeLevel'], null=True, blank=True)),
            ('removed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('sheet', ['CharacterLogEntry'])

        # Adding field 'Sheet.last_update_at'
        db.add_column('sheet_sheet', 'last_update_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 7, 19, 19, 38, 53, 62961), blank=True), keep_default=False)

        # Adding field 'Character.last_update_at'
        db.add_column('sheet_character', 'last_update_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 7, 19, 19, 38, 59, 638776), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'CharacterLogEntry'
        db.delete_table('sheet_characterlogentry')

        # Deleting field 'Sheet.last_update_at'
        db.delete_column('sheet_sheet', 'last_update_at')

        # Deleting field 'Character.last_update_at'
        db.delete_column('sheet_character', 'last_update_at')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 19, 19, 38, 59, 666668)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 19, 19, 38, 59, 666555)'}),
        ...
        'sheet.characterlogentry': {
            'Meta': {'object_name': 'CharacterLogEntry'},
