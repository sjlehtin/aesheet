...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeaponSpecialQuality.notes'
        db.add_column(u'sheet_weaponspecialquality', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.cc_skill_levels'
        db.add_column(u'sheet_weaponspecialquality', 'cc_skill_levels',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.fit'
        db.add_column(u'sheet_weaponspecialquality', 'fit',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.ref'
        db.add_column(u'sheet_weaponspecialquality', 'ref',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.lrn'
        db.add_column(u'sheet_weaponspecialquality', 'lrn',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.int'
        db.add_column(u'sheet_weaponspecialquality', 'int',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.psy'
        db.add_column(u'sheet_weaponspecialquality', 'psy',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.wil'
        db.add_column(u'sheet_weaponspecialquality', 'wil',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.cha'
        db.add_column(u'sheet_weaponspecialquality', 'cha',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.pos'
        db.add_column(u'sheet_weaponspecialquality', 'pos',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.mov'
        db.add_column(u'sheet_weaponspecialquality', 'mov',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.dex'
        db.add_column(u'sheet_weaponspecialquality', 'dex',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.imm'
        db.add_column(u'sheet_weaponspecialquality', 'imm',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.saves_vs_fire'
        db.add_column(u'sheet_weaponspecialquality', 'saves_vs_fire',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.saves_vs_cold'
        db.add_column(u'sheet_weaponspecialquality', 'saves_vs_cold',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.saves_vs_lightning'
        db.add_column(u'sheet_weaponspecialquality', 'saves_vs_lightning',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.saves_vs_poison'
        db.add_column(u'sheet_weaponspecialquality', 'saves_vs_poison',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.saves_vs_all'
        db.add_column(u'sheet_weaponspecialquality', 'saves_vs_all',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeaponSpecialQuality.type'
        db.add_column(u'sheet_weaponspecialquality', 'type',
                      self.gf('django.db.models.fields.CharField')(default='enhancement', max_length=256),
                      keep_default=False)


        # Changing field 'WeaponSpecialQuality.description'
        db.alter_column(u'sheet_weaponspecialquality', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'WeaponSpecialQuality.name'
        db.alter_column(u'sheet_weaponspecialquality', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, primary_key=True))

    def backwards(self, orm):
        # Deleting field 'WeaponSpecialQuality.notes'
        db.delete_column(u'sheet_weaponspecialquality', 'notes')

        # Deleting field 'WeaponSpecialQuality.cc_skill_levels'
        db.delete_column(u'sheet_weaponspecialquality', 'cc_skill_levels')

        # Deleting field 'WeaponSpecialQuality.fit'
        db.delete_column(u'sheet_weaponspecialquality', 'fit')

        # Deleting field 'WeaponSpecialQuality.ref'
        db.delete_column(u'sheet_weaponspecialquality', 'ref')

        # Deleting field 'WeaponSpecialQuality.lrn'
        db.delete_column(u'sheet_weaponspecialquality', 'lrn')

        # Deleting field 'WeaponSpecialQuality.int'
        db.delete_column(u'sheet_weaponspecialquality', 'int')

        # Deleting field 'WeaponSpecialQuality.psy'
        db.delete_column(u'sheet_weaponspecialquality', 'psy')

        # Deleting field 'WeaponSpecialQuality.wil'
        db.delete_column(u'sheet_weaponspecialquality', 'wil')

        # Deleting field 'WeaponSpecialQuality.cha'
        db.delete_column(u'sheet_weaponspecialquality', 'cha')

        # Deleting field 'WeaponSpecialQuality.pos'
        db.delete_column(u'sheet_weaponspecialquality', 'pos')

        # Deleting field 'WeaponSpecialQuality.mov'
        db.delete_column(u'sheet_weaponspecialquality', 'mov')

        # Deleting field 'WeaponSpecialQuality.dex'
        db.delete_column(u'sheet_weaponspecialquality', 'dex')

        # Deleting field 'WeaponSpecialQuality.imm'
        db.delete_column(u'sheet_weaponspecialquality', 'imm')

        # Deleting field 'WeaponSpecialQuality.saves_vs_fire'
        db.delete_column(u'sheet_weaponspecialquality', 'saves_vs_fire')

        # Deleting field 'WeaponSpecialQuality.saves_vs_cold'
        db.delete_column(u'sheet_weaponspecialquality', 'saves_vs_cold')

        # Deleting field 'WeaponSpecialQuality.saves_vs_lightning'
        db.delete_column(u'sheet_weaponspecialquality', 'saves_vs_lightning')

        # Deleting field 'WeaponSpecialQuality.saves_vs_poison'
        db.delete_column(u'sheet_weaponspecialquality', 'saves_vs_poison')

        # Deleting field 'WeaponSpecialQuality.saves_vs_all'
        db.delete_column(u'sheet_weaponspecialquality', 'saves_vs_all')

        # Deleting field 'WeaponSpecialQuality.type'
        db.delete_column(u'sheet_weaponspecialquality', 'type')


        # Changing field 'WeaponSpecialQuality.description'
        db.alter_column(u'sheet_weaponspecialquality', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'WeaponSpecialQuality.name'
        db.alter_column(u'sheet_weaponspecialquality', 'name', self.gf('django.db.models.fields.CharField')(max_length=32, primary_key=True))
