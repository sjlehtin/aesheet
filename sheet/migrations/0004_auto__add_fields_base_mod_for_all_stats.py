...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Character.base_mod_fit'
        db.add_column('sheet_character', 'base_mod_fit', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Character.base_mod_ref'
        db.add_column('sheet_character', 'base_mod_ref', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Character.base_mod_lrn'
        db.add_column('sheet_character', 'base_mod_lrn', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Character.base_mod_int'
        db.add_column('sheet_character', 'base_mod_int', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Character.base_mod_psy'
        db.add_column('sheet_character', 'base_mod_psy', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Character.base_mod_wil'
        db.add_column('sheet_character', 'base_mod_wil', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Character.base_mod_cha'
        db.add_column('sheet_character', 'base_mod_cha', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Character.base_mod_pos'
        db.add_column('sheet_character', 'base_mod_pos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Character.base_mod_mov'
        db.add_column('sheet_character', 'base_mod_mov', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Character.base_mod_dex'
        db.add_column('sheet_character', 'base_mod_dex', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Character.base_mod_imm'
        db.add_column('sheet_character', 'base_mod_imm', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Character.base_mod_fit'
        db.delete_column('sheet_character', 'base_mod_fit')

        # Deleting field 'Character.base_mod_ref'
        db.delete_column('sheet_character', 'base_mod_ref')

        # Deleting field 'Character.base_mod_lrn'
        db.delete_column('sheet_character', 'base_mod_lrn')

        # Deleting field 'Character.base_mod_int'
        db.delete_column('sheet_character', 'base_mod_int')

        # Deleting field 'Character.base_mod_psy'
        db.delete_column('sheet_character', 'base_mod_psy')

        # Deleting field 'Character.base_mod_wil'
        db.delete_column('sheet_character', 'base_mod_wil')

        # Deleting field 'Character.base_mod_cha'
        db.delete_column('sheet_character', 'base_mod_cha')

        # Deleting field 'Character.base_mod_pos'
        db.delete_column('sheet_character', 'base_mod_pos')

        # Deleting field 'Character.base_mod_mov'
        db.delete_column('sheet_character', 'base_mod_mov')

        # Deleting field 'Character.base_mod_dex'
        db.delete_column('sheet_character', 'base_mod_dex')

        # Deleting field 'Character.base_mod_imm'
        db.delete_column('sheet_character', 'base_mod_imm')
