...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sheet.extra_weight_carried'
        db.add_column('sheet_sheet', 'extra_weight_carried', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sheet.extra_weight_carried'
        db.delete_column('sheet_sheet', 'extra_weight_carried')
