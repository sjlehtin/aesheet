...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RangedWeaponTemplate.weapon_type'
        db.add_column(u'sheet_rangedweapontemplate', 'weapon_type',
                      self.gf('django.db.models.fields.CharField')(default='thrown', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RangedWeaponTemplate.weapon_type'
        db.delete_column(u'sheet_rangedweapontemplate', 'weapon_type')
