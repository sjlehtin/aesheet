...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Character.edges_bougth'
        db.delete_column('sheet_character', 'edges_bougth')

        # Adding field 'Character.edges_bought'
        db.add_column('sheet_character', 'edges_bought', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Changing field 'Character.times_wounded'
        db.alter_column('sheet_character', 'times_wounded', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.start_ref'
        db.alter_column('sheet_character', 'start_ref', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.bought_stamina'
        db.alter_column('sheet_character', 'bought_stamina', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.start_int'
        db.alter_column('sheet_character', 'start_int', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.start_wil'
        db.alter_column('sheet_character', 'start_wil', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.gained_sp'
        db.alter_column('sheet_character', 'gained_sp', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.cur_fit'
        db.alter_column('sheet_character', 'cur_fit', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.total_xp'
        db.alter_column('sheet_character', 'total_xp', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.cur_lrn'
        db.alter_column('sheet_character', 'cur_lrn', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.age'
        db.alter_column('sheet_character', 'age', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.start_cha'
        db.alter_column('sheet_character', 'start_cha', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.start_pos'
        db.alter_column('sheet_character', 'start_pos', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.cur_psy'
        db.alter_column('sheet_character', 'cur_psy', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.cur_wil'
        db.alter_column('sheet_character', 'cur_wil', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.bought_mana'
        db.alter_column('sheet_character', 'bought_mana', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.cur_ref'
        db.alter_column('sheet_character', 'cur_ref', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.start_fit'
        db.alter_column('sheet_character', 'start_fit', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.xp_used_ingame'
        db.alter_column('sheet_character', 'xp_used_ingame', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.cur_int'
        db.alter_column('sheet_character', 'cur_int', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.cur_cha'
        db.alter_column('sheet_character', 'cur_cha', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.adventures'
        db.alter_column('sheet_character', 'adventures', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.start_lrn'
        db.alter_column('sheet_character', 'start_lrn', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.start_psy'
        db.alter_column('sheet_character', 'start_psy', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.cur_pos'
        db.alter_column('sheet_character', 'cur_pos', self.gf('django.db.models.fields.PositiveIntegerField')())


    def backwards(self, orm):
        
        # Adding field 'Character.edges_bougth'
        db.add_column('sheet_character', 'edges_bougth', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Character.edges_bought'
        db.delete_column('sheet_character', 'edges_bought')

        # Changing field 'Character.times_wounded'
        db.alter_column('sheet_character', 'times_wounded', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.start_ref'
        db.alter_column('sheet_character', 'start_ref', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.bought_stamina'
        db.alter_column('sheet_character', 'bought_stamina', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.start_int'
        db.alter_column('sheet_character', 'start_int', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.start_wil'
        db.alter_column('sheet_character', 'start_wil', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.gained_sp'
        db.alter_column('sheet_character', 'gained_sp', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.cur_fit'
        db.alter_column('sheet_character', 'cur_fit', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.total_xp'
        db.alter_column('sheet_character', 'total_xp', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.cur_lrn'
        db.alter_column('sheet_character', 'cur_lrn', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.age'
        db.alter_column('sheet_character', 'age', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.start_cha'
        db.alter_column('sheet_character', 'start_cha', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.start_pos'
        db.alter_column('sheet_character', 'start_pos', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.cur_psy'
        db.alter_column('sheet_character', 'cur_psy', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.cur_wil'
        db.alter_column('sheet_character', 'cur_wil', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.bought_mana'
        db.alter_column('sheet_character', 'bought_mana', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.cur_ref'
        db.alter_column('sheet_character', 'cur_ref', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.start_fit'
        db.alter_column('sheet_character', 'start_fit', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.xp_used_ingame'
        db.alter_column('sheet_character', 'xp_used_ingame', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.cur_int'
        db.alter_column('sheet_character', 'cur_int', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.cur_cha'
        db.alter_column('sheet_character', 'cur_cha', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.adventures'
        db.alter_column('sheet_character', 'adventures', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.start_lrn'
        db.alter_column('sheet_character', 'start_lrn', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.start_psy'
        db.alter_column('sheet_character', 'start_psy', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.cur_pos'
        db.alter_column('sheet_character', 'cur_pos', self.gf('django.db.models.fields.IntegerField')())
