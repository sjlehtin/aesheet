...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ammunition.bypass'
        db.add_column(u'sheet_ammunition', 'bypass',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'BaseFirearm.bypass'
        db.delete_column(u'sheet_basefirearm', 'bypass')


    def backwards(self, orm):
        # Deleting field 'Ammunition.bypass'
        db.delete_column(u'sheet_ammunition', 'bypass')

        # Adding field 'BaseFirearm.bypass'
        db.add_column(u'sheet_basefirearm', 'bypass',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
