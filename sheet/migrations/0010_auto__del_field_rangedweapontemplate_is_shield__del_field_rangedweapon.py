...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RangedWeaponTemplate.is_shield'
        db.delete_column('sheet_rangedweapontemplate', 'is_shield')

        # Deleting field 'RangedWeaponTemplate.ccv'
        db.delete_column('sheet_rangedweapontemplate', 'ccv')

        # Deleting field 'RangedWeaponTemplate.ccv_unskilled_modifier'
        db.delete_column('sheet_rangedweapontemplate', 'ccv_unskilled_modifier')

        # Deleting field 'RangedWeaponTemplate.is_lance'
        db.delete_column('sheet_rangedweapontemplate', 'is_lance')

        # Deleting field 'RangedWeaponTemplate.defense_leth'
        db.delete_column('sheet_rangedweapontemplate', 'defense_leth')


    def backwards(self, orm):
        # Adding field 'RangedWeaponTemplate.is_shield'
        db.add_column('sheet_rangedweapontemplate', 'is_shield',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RangedWeaponTemplate.ccv'
        db.add_column('sheet_rangedweapontemplate', 'ccv',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)

        # Adding field 'RangedWeaponTemplate.ccv_unskilled_modifier'
        db.add_column('sheet_rangedweapontemplate', 'ccv_unskilled_modifier',
                      self.gf('django.db.models.fields.IntegerField')(default=-10),
                      keep_default=False)

        # Adding field 'RangedWeaponTemplate.is_lance'
        db.add_column('sheet_rangedweapontemplate', 'is_lance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RangedWeaponTemplate.defense_leth'
        db.add_column('sheet_rangedweapontemplate', 'defense_leth',
