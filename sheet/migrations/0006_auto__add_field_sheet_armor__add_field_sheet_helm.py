...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sheet.armor'
        db.add_column('sheet_sheet', 'armor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.Armor'], null=True, blank=True), keep_default=False)

        # Adding field 'Sheet.helm'
        db.add_column('sheet_sheet', 'helm', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='helm_for', null=True, to=orm['sheet.Armor']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Sheet.armor'
        db.delete_column('sheet_sheet', 'armor_id')

        # Deleting field 'Sheet.helm'
        db.delete_column('sheet_sheet', 'helm_id')
