...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ArmorQuality.id'
        db.delete_column('sheet_armorquality', 'id')

        # Changing field 'ArmorQuality.name'
        db.alter_column('sheet_armorquality', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, primary_key=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ArmorQuality.id'
        raise RuntimeError("Cannot reverse this migration. 'ArmorQuality.id' and its values cannot be restored.")

        # Changing field 'ArmorQuality.name'
        db.alter_column('sheet_armorquality', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True))
