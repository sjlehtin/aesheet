...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sheet.owner'
        db.add_column('sheet_sheet', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='sheets', to=orm['auth.User']), keep_default=False)

        # Adding field 'Character.owner'
        db.add_column('sheet_character', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='characters', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sheet.owner'
        db.delete_column('sheet_sheet', 'owner_id')

        # Deleting field 'Character.owner'
        db.delete_column('sheet_character', 'owner_id')
