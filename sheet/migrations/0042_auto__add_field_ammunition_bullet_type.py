...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ammunition.bullet_type'
        db.add_column(u'sheet_ammunition', 'bullet_type',
                      self.gf('django.db.models.fields.CharField')(default='FMJ', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ammunition.bullet_type'
        db.delete_column(u'sheet_ammunition', 'bullet_type')
