...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Firearm'
        db.create_table(u'sheet_firearm', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('base', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.BaseFirearm'])),
            ('ammo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.Ammunition'])),
        ))
        ...
        db.create_table(u'sheet_basefirearm', (
            ...
            ('bypass', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('base_skill', self.gf('django.db.models.fields.related.ForeignKey')(related_name='base_skill_for_basefirearm', to=orm['sheet.Skill'])),
            ('skill', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='primary_for_basefirearm', null=True, to=orm['sheet.Skill'])),
            ('skill2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='secondary_for_basefirearm', null=True, to=orm['sheet.Skill'])),
            ('type', self.gf('django.db.models.fields.CharField')(default='P', max_length=5)),
            ('target_initiative', self.gf('django.db.models.fields.IntegerField')(default=-2)),
            ('ammo_weight', self.gf('django.db.models.fields.DecimalField')(default=0.1, max_digits=4, decimal_places=1)),
            ('range_pb', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('range_xs', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('range_vs', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('range_s', self.gf('django.db.models.fields.IntegerField')()),
            ('range_m', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.alter_column(u'sheet_rangedweapontemplate', 'range_e', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'RangedWeaponTemplate.range_xl'
        db.alter_column(u'sheet_rangedweapontemplate', 'range_xl', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'RangedWeaponTemplate.range_vs'
        db.alter_column(u'sheet_rangedweapontemplate', 'range_vs', self.gf('django.db.models.fields.IntegerField')(null=True))
