...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WeaponQuality.notes'
        db.add_column('sheet_weaponquality', 'notes', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WeaponQuality.notes'
        db.delete_column('sheet_weaponquality', 'notes')
