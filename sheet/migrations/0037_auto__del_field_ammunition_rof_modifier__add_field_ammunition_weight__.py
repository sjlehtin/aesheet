...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ammunition.rof_modifier'
        db.delete_column(u'sheet_ammunition', 'rof_modifier')

        # Adding field 'Ammunition.weight'
        db.add_column(u'sheet_ammunition', 'weight',
                      self.gf('django.db.models.fields.DecimalField')(default=7.5, max_digits=7, decimal_places=3),
                      keep_default=False)

        # Adding field 'Ammunition.velocity'
        db.add_column(u'sheet_ammunition', 'velocity',
                      self.gf('django.db.models.fields.IntegerField')(default=440),
                      keep_default=False)

        # Deleting field 'BaseFirearm.roa'
        db.delete_column(u'sheet_basefirearm', 'roa')

        # Deleting field 'BaseFirearm.ammo_weight'
        db.delete_column(u'sheet_basefirearm', 'ammo_weight')

        # Adding field 'BaseFirearm.stock'
        db.add_column(u'sheet_basefirearm', 'stock',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Adding field 'BaseFirearm.duration'
        db.add_column(u'sheet_basefirearm', 'duration',
                      self.gf('django.db.models.fields.DecimalField')(default=0.1, max_digits=5, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Ammunition.rof_modifier'
        db.add_column(u'sheet_ammunition', 'rof_modifier',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Ammunition.weight'
        db.delete_column(u'sheet_ammunition', 'weight')

        # Deleting field 'Ammunition.velocity'
        db.delete_column(u'sheet_ammunition', 'velocity')

        # Adding field 'BaseFirearm.roa'
        db.add_column(u'sheet_basefirearm', 'roa',
                      self.gf('django.db.models.fields.DecimalField')(default=1.0, max_digits=4, decimal_places=3),
                      keep_default=False)

        # Adding field 'BaseFirearm.ammo_weight'
        db.add_column(u'sheet_basefirearm', 'ammo_weight',
                      self.gf('django.db.models.fields.DecimalField')(default=0.1, max_digits=4, decimal_places=1),
                      keep_default=False)

        # Deleting field 'BaseFirearm.stock'
        db.delete_column(u'sheet_basefirearm', 'stock')

        # Deleting field 'BaseFirearm.duration'
        db.delete_column(u'sheet_basefirearm', 'duration')
