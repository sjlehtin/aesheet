...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RangedWeaponTemplate.tech_level'
        db.add_column('sheet_rangedweapontemplate', 'tech_level',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sheet.TechLevel']),
                      keep_default=False)

        # Adding field 'ArmorTemplate.tech_level'
        db.add_column('sheet_armortemplate', 'tech_level',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sheet.TechLevel']),
                      keep_default=False)

        # Adding field 'ArmorQuality.tech_level'
        db.add_column('sheet_armorquality', 'tech_level',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sheet.TechLevel']),
                      keep_default=False)

        # Adding field 'Character.campaign'
        db.add_column('sheet_character', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sheet.Campaign']),
                      keep_default=False)

        # Adding field 'Skill.tech_level'
        db.add_column('sheet_skill', 'tech_level',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sheet.TechLevel']),
                      keep_default=False)

        # Adding field 'WeaponTemplate.tech_level'
        db.add_column('sheet_weapontemplate', 'tech_level',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sheet.TechLevel']),
                      keep_default=False)

        # Adding field 'WeaponQuality.tech_level'
        db.add_column('sheet_weaponquality', 'tech_level',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sheet.TechLevel']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RangedWeaponTemplate.tech_level'
        db.delete_column('sheet_rangedweapontemplate', 'tech_level_id')

        # Deleting field 'ArmorTemplate.tech_level'
        db.delete_column('sheet_armortemplate', 'tech_level_id')

        # Deleting field 'ArmorQuality.tech_level'
        db.delete_column('sheet_armorquality', 'tech_level_id')

        # Deleting field 'Character.campaign'
        db.delete_column('sheet_character', 'campaign_id')

        # Deleting field 'Skill.tech_level'
        db.delete_column('sheet_skill', 'tech_level_id')

        # Deleting field 'WeaponTemplate.tech_level'
        db.delete_column('sheet_weapontemplate', 'tech_level_id')

        # Deleting field 'WeaponQuality.tech_level'
        db.delete_column('sheet_weaponquality', 'tech_level_id')
