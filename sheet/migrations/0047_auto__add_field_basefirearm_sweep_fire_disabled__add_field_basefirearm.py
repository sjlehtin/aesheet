...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseFirearm.sweep_fire_disabled'
        db.add_column(u'sheet_basefirearm', 'sweep_fire_disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BaseFirearm.restricted_burst_rounds'
        db.add_column(u'sheet_basefirearm', 'restricted_burst_rounds',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BaseFirearm.weapon_class_modifier'
        db.add_column(u'sheet_basefirearm', 'weapon_class_modifier',
                      self.gf('django.db.models.fields.DecimalField')(default=6, max_digits=4, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseFirearm.sweep_fire_disabled'
        db.delete_column(u'sheet_basefirearm', 'sweep_fire_disabled')

        # Deleting field 'BaseFirearm.restricted_burst_rounds'
        db.delete_column(u'sheet_basefirearm', 'restricted_burst_rounds')

        # Deleting field 'BaseFirearm.weapon_class_modifier'
        db.delete_column(u'sheet_basefirearm', 'weapon_class_modifier')
