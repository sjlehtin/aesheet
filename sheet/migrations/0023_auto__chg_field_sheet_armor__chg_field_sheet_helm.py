...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sheet.armor'
        db.alter_column('sheet_sheet', 'armor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.Armor'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Sheet.helm'
        db.alter_column('sheet_sheet', 'helm_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['sheet.Armor']))

    def backwards(self, orm):

        # Changing field 'Sheet.armor'
        db.alter_column('sheet_sheet', 'armor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sheet.Armor'], null=True))

        # Changing field 'Sheet.helm'
        db.alter_column('sheet_sheet', 'helm_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sheet.Armor']))
