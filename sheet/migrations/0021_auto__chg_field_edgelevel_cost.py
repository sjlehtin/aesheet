...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EdgeLevel.cost'
        db.alter_column('sheet_edgelevel', 'cost', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=1))


    def backwards(self, orm):
        
        # Changing field 'EdgeLevel.cost'
        db.alter_column('sheet_edgelevel', 'cost', self.gf('django.db.models.fields.IntegerField')())
