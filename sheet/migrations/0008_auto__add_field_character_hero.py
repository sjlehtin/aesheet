...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Character.hero'
        db.add_column('sheet_character', 'hero', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Character.hero'
        db.delete_column('sheet_character', 'hero')
