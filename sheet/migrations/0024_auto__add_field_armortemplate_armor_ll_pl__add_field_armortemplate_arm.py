...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArmorTemplate.armor_ll_pl'
        db.add_column('sheet_armortemplate', 'armor_ll_pl',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ArmorTemplate.armor_rl_pl'
        db.add_column('sheet_armortemplate', 'armor_rl_pl',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ArmorTemplate.armor_la_pl'
        db.add_column('sheet_armortemplate', 'armor_la_pl',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ArmorTemplate.armor_ra_pl'
        db.add_column('sheet_armortemplate', 'armor_ra_pl',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArmorTemplate.armor_ll_pl'
        db.delete_column('sheet_armortemplate', 'armor_ll_pl')

        # Deleting field 'ArmorTemplate.armor_rl_pl'
        db.delete_column('sheet_armortemplate', 'armor_rl_pl')

        # Deleting field 'ArmorTemplate.armor_la_pl'
        db.delete_column('sheet_armortemplate', 'armor_la_pl')

        # Deleting field 'ArmorTemplate.armor_ra_pl'
        db.delete_column('sheet_armortemplate', 'armor_ra_pl')
    ...
    models = {
        ...
        'sheet.sheet': {
            ...
            'armor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sheet.Armor']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'character': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sheet.Character']"}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'extra_weight_carried': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'helm': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'helm_for'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['sheet.Armor']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
