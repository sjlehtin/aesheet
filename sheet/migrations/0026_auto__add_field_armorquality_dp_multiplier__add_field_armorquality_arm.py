...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ArmorQuality.dp_multiplier'
        db.add_column('sheet_armorquality', 'dp_multiplier', self.gf('django.db.models.fields.DecimalField')(default=1.0, max_digits=4, decimal_places=1), keep_default=False)
        ...
        # Adding field 'ArmorQuality.mod_fit_multiplier'
        db.add_column('sheet_armorquality', 'mod_fit_multiplier', self.gf('django.db.models.fields.DecimalField')(default=1.0, max_digits=4, decimal_places=1), keep_default=False)

        # Adding field 'ArmorQuality.mod_fit'
        db.add_column('sheet_armorquality', 'mod_fit', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ArmorQuality.mod_ref'
        db.add_column('sheet_armorquality', 'mod_ref', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ArmorQuality.mod_psy'
        db.add_column('sheet_armorquality', 'mod_psy', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ArmorQuality.mod_sensory'
        db.add_column('sheet_armorquality', 'mod_sensory', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ArmorQuality.mod_stealth'
        db.add_column('sheet_armorquality', 'mod_stealth', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ArmorQuality.mod_conceal'
        db.add_column('sheet_armorquality', 'mod_conceal', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ArmorQuality.mod_climb'
        db.add_column('sheet_armorquality', 'mod_climb', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ArmorQuality.mod_weight_multiplier'
        db.add_column('sheet_armorquality', 'mod_weight_multiplier', self.gf('django.db.models.fields.DecimalField')(default=1.0, max_digits=4, decimal_places=1), keep_default=False)
        ...
        # Changing field 'ArmorQuality.short_name'
        db.alter_column('sheet_armorquality', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=5, blank=True))

        # Changing field 'WeaponQuality.short_name'
        db.alter_column('sheet_weaponquality', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=5, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'ArmorQuality.dp_multiplier'
        db.delete_column('sheet_armorquality', 'dp_multiplier')
        ...
        # Deleting field 'ArmorQuality.mod_fit_multiplier'
        db.delete_column('sheet_armorquality', 'mod_fit_multiplier')

        # Deleting field 'ArmorQuality.mod_fit'
        db.delete_column('sheet_armorquality', 'mod_fit')

        # Deleting field 'ArmorQuality.mod_ref'
        db.delete_column('sheet_armorquality', 'mod_ref')

        # Deleting field 'ArmorQuality.mod_psy'
        db.delete_column('sheet_armorquality', 'mod_psy')

        # Deleting field 'ArmorQuality.mod_sensory'
        db.delete_column('sheet_armorquality', 'mod_sensory')

        # Deleting field 'ArmorQuality.mod_stealth'
        db.delete_column('sheet_armorquality', 'mod_stealth')

        # Deleting field 'ArmorQuality.mod_conceal'
        db.delete_column('sheet_armorquality', 'mod_conceal')

        # Deleting field 'ArmorQuality.mod_climb'
        db.delete_column('sheet_armorquality', 'mod_climb')

        # Deleting field 'ArmorQuality.mod_weight_multiplier'
        db.delete_column('sheet_armorquality', 'mod_weight_multiplier')

        # Deleting field 'ArmorQuality.mod_class'
        db.delete_column('sheet_armorquality', 'mod_class')

        # Changing field 'ArmorQuality.short_name'
        db.alter_column('sheet_armorquality', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'WeaponQuality.short_name'
        db.alter_column('sheet_weaponquality', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=5))
