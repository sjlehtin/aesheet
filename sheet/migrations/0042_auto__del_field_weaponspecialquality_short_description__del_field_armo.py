...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WeaponSpecialQuality.short_description'
        db.delete_column('sheet_weaponspecialquality', 'short_description')

        # Deleting field 'ArmorSpecialQuality.short_description'
        db.delete_column('sheet_armorspecialquality', 'short_description')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'WeaponSpecialQuality.short_description'
        raise RuntimeError("Cannot reverse this migration. 'WeaponSpecialQuality.short_description' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ArmorSpecialQuality.short_description'
        raise RuntimeError("Cannot reverse this migration. 'ArmorSpecialQuality.short_description' and its values cannot be restored.")
