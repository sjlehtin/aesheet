...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WeaponTemplate.weight'
        db.add_column('sheet_weapontemplate', 'weight', self.gf('django.db.models.fields.DecimalField')(default=1.0, max_digits=4, decimal_places=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WeaponTemplate.weight'
        db.delete_column('sheet_weapontemplate', 'weight')
