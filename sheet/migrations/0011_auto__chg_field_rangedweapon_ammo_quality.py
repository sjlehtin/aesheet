...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RangedWeapon.ammo_quality'
        db.alter_column('sheet_rangedweapon', 'ammo_quality_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sheet.WeaponQuality']))

    def backwards(self, orm):

        # Changing field 'RangedWeapon.ammo_quality'
        db.alter_column('sheet_rangedweapon', 'ammo_quality_id', self.gf('django.db.models.fields.related.ForeignKey')(default='normal', to=orm['sheet.WeaponQuality']))
