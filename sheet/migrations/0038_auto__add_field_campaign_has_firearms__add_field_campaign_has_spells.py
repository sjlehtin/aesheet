...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.has_firearms'
        db.add_column(u'sheet_campaign', 'has_firearms',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Campaign.has_spells'
        db.add_column(u'sheet_campaign', 'has_spells',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.has_firearms'
        db.delete_column(u'sheet_campaign', 'has_firearms')

        # Deleting field 'Campaign.has_spells'
        db.delete_column(u'sheet_campaign', 'has_spells')
