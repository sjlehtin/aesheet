...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('sheet_helm', (
            ('armor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='helms', to=orm['sheet.Armor'])),
            ('sheet', self.gf('django.db.models.fields.related.OneToOneField')(related_name='helm', unique=True, to=orm['sheet.Sheet'])),
            ('armor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sheet.Armor'], unique=True, primary_key=True)),
        ))
