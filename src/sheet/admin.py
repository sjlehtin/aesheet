...
admin.site.register(sm.BaseFirearmNew, BaseFirearmAdmin)
...
admin.site.register(sm.SkillNew, SkillAdmin)
...
admin.site.register(sm.WeaponTemplateNew, WeaponTemplateAdmin)
...
admin.site.register(sm.RangedWeaponTemplateNew, RangedWeaponTemplateAdmin)
